...
""";
  ...
  final lintModule = JsObject.fromBrowserObject(context['BpmnJSBpmnlint']);
  const lintConfig = """
{
...
""";
  ...
  final area = querySelector('#output');

  final modeler = BpmnJS.withCustomOptions(bpmnCustomOptions({
    'container': area,
    "linting": {
      "bpmnlint": lintConfig,
    },
